...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipytest-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6601&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipytest-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipytest` can be installed with:

```
conda install ipytest
```

It is possible to list all of the versions of `ipytest` available on your platform with:
